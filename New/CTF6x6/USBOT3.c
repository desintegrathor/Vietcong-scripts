/*
 * USBOT3.c - Bot AI Script (Generated from USBOT0_reconstructed.c)
 ...
 */
void SetupUS(s_SC_P_Create *pinfo) {
    pinfo->inifile = "Ini\\Players\\NET_US_HORNSTER.ini";
    pinfo->name_nr = 2499;       // US SF name ID
    pinfo->weap_pistol = 7;      // Weapon ID for pistol slot
    pinfo->weap_main1 = 21;       // Weapon ID for main weapon
