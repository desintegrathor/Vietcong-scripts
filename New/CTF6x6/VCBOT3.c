/*
 * VCBOT3.c - Bot AI Script (Generated from USBOT0_reconstructed.c)
 ...
 */
void SetupVC(s_SC_P_Create *pinfo) {
    pinfo->inifile = "Ini\\Players\\NET_VC_UNIFORM2.ini";
    pinfo->name_nr = 2506;       // VC officer name ID
    pinfo->weap_pistol = 8;      // Weapon ID for pistol slot
    pinfo->weap_main1 = 15;       // Weapon ID for main weapon
...
void CreateBot(s_SC_P_info *info) {
    ...
    pinfo.side = SC_P_SIDE_VC;  // VC side
    pinfo.group = 0;
    pinfo.member_id = 3;
