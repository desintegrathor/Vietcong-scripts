/*
 * VCBOT4.c - Bot AI Script (Generated from USBOT0_reconstructed.c)
 ...
 */
void SetupVC(s_SC_P_Create *pinfo) {
    pinfo->inifile = "Ini\\Players\\NET_VC_UNIFORM3.ini";
    pinfo->name_nr = 2506;       // VC officer name ID
    pinfo->weap_pistol = 9;      // Weapon ID for pistol slot
    pinfo->weap_main1 = 23;       // Weapon ID for main weapon
